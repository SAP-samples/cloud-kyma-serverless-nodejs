...
function _readInt64(buffer, offset, unsigned, bigEndian) {

  var x, y, s, y0, y1, x0, x1, x2;

  if(bigEndian) {
    y = buffer[offset + 1] << 16;
    y |= buffer[offset + 2] << 8;
    y |= buffer[offset + 3];
    y += buffer[offset] << 24 >>> 0;
    offset += 4;

    x = buffer[offset + 1] << 16;
    x |= buffer[offset + 2] << 8;
    x |= buffer[offset + 3];
    x += buffer[offset] << 24 >>> 0;
  } else {
...
function _writeInt64(buffer, value, offset, unsigned, bigEndian) {
  ...
  if(bigEndian) {
    buffer[offset] = (x1 >>> 24) & 0xff;
    buffer[offset + 1] = (x1 >>> 16) & 0xff;
    buffer[offset + 2] = (x1 >>> 8) & 0xff;
    buffer[offset + 3] = x1 & 0xff;
    offset += 4;

    buffer[offset] = (x0 >>> 24) & 0xff;
    buffer[offset + 1] = (x0 >>> 16) & 0xff;
    buffer[offset + 2] = (x0 >>> 8) & 0xff;
    buffer[offset + 3] = x0 & 0xff;
  } else {
...
function readInt64(buffer, offset) {
  return _readInt64(buffer, offset || 0, false, false);
}

function readInt64BE(buffer, offset) {
  return _readInt64(buffer, offset || 0, false, true);
}

function readUInt64(buffer, offset) {
  return _readInt64(buffer, offset || 0, true, false);
}

function readUInt64BE(buffer, offset) {
  return _readInt64(buffer, offset || 0, true, true);
}

function writeInt64(buffer, value, offset) {
  _writeInt64(buffer, value, offset || 0, false, false);
}

function writeInt64BE(buffer, value, offset) {
  _writeInt64(buffer, value, offset || 0, false, true);
}

function writeUInt64(buffer, value, offset) {
  _writeInt64(buffer, value, offset || 0, true, false);
}

function writeUInt64BE(buffer, value, offset) {
  _writeInt64(buffer, value, offset || 0, true, true);
}
